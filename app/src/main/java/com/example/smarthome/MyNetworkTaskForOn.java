...
public class MyNetworkTaskForOn {

    Context myContext;

    public MyNetworkTaskForOn(Context context) {
    ...
    //private static final String CERTIFICATE_ID = "android_client_der";
    ...
    public void createMyAsyncTaskForOnLed2() {
    ...
    public void createMyAsyncTaskForOnLed4() {
    ...
    void initIoTClient() {
        ...
        try {
            Log.i("SmartHome", "Keystore Path: " + keystorePath);
